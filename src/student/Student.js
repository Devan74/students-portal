...
function Student() {
    ...
    let fetchData = async () => {
        try {
            setLoading(true)
            const students = await axios.get("https://634d24beacb391d34a9511f4.mockapi.io/admin/student")
    ...
    const deleteStudent = async (rollnumber) => {
        ...
        if (result) {
            try {
                await axios.delete(`https://634d24beacb391d34a9511f4.mockapi.io/admin/student/${rollnumber}`);
                setStudent(students.filter(student => student.rollnumber !== rollnumber));
            } catch (error) {
                                    ...
                                    {students.map((student) => {
                                        return <tr key={student.rollnumber}>
                                            ...
                                            <td>
                                                ...
                                                <button onClick={() => deleteStudent(student.rollnumber)} className='btn btn-danger  '>
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
